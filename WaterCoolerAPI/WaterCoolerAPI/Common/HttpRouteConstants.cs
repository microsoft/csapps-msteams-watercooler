...
namespace WaterCoolerAPI.Common
{
    ...
    public static class HttpRouteConstants
    {
        ...
        /// <summary>
        /// Route for getting ActiveRooms for a call.
        /// </summary>
        public const string GetActiveRoomList = "GetActiveRoomList";

        /// <summary>
        /// Route for getting ActiveParticipants for a call.
        /// </summary>
        public const string GetActiveParticipantList = "GetActiveParticipantList";
